...
the "official" tool from SQLAlchemy authors does not seem to make it easily possible.

Because this special requirement we had to make custom implementation for it.
