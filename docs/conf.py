...
# Using `autodoc_use_legacy_class_based = True` or downgrading Sphinx to v8 fixes the issue
# with the simple example from that issue, but neither works for FlexGet. I'm not sure why.
# Here, importing all modules beforehand works around the issue.
