...
install_requires = ['FeedParser>=5.1.3', 'SQLAlchemy >=0.7.5, !=0.9.0, <1.999', 'PyYAML',
                    ...
                    'python-tvrage', 'tmdb3', 'path.py', 'apscheduler']
if sys.version_info < (2, 7):
    # argparse is part of the standard library in python 2.7+
    install_requires.append('argparse')
    # guessit dropped 2.6 support with 0.10.4
    install_requires.append('guessit>=0.9.3, <0.10.4')
else:
    install_requires.append('guessit>=0.9.3')
