...
class TestTVMazeShowLookup(object):
    ...
    def test_lookup_name(self, use_vcr, execute_task):
    ...
    def test_lookup(self, use_vcr, execute_task):
        task = execute_task('test')
        entry = task.find_entry(title='House.S01E02.HDTV.XViD-FlexGet')
    ...
    def test_unknown_series(self, use_vcr, execute_task):
    ...
    def test_search_results(self, use_vcr, execute_task):
    ...
    def test_date(self, use_vcr, execute_task):
    ...
    def test_title_with_year(self, use_vcr, execute_task):
    ...
    def test_from_filesystem(self, use_vcr, execute_task):
    ...
    def test_series_expiration(self, use_vcr, execute_task):
    ...
    def test_test_show_is_number(self, use_vcr, execute_task):
    ...
    def test_show_contain_number(self, use_vcr, execute_task):
    ...
    def test_episode_without_air_date_and_air_stamp(self, use_vcr, execute_task):
    ...
    def test_episode_summary(self, use_vcr, execute_task):
    ...
    def test_show_with_non_ascii_chars(self, use_vcr, execute_task):
    ...
    def test_show_cast(self, use_vcr, execute_task):
    ...
    def test_episode_air_date(self, use_vcr, execute_task):
    ...
    def test_queries_via_ids(self, use_vcr, execute_task):
