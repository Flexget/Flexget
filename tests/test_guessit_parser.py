...
from flexget.utils.parsers import get_parser

class TestGuessitParser:
    def test_parsing(self):
        for parser in [get_parser('GuessitParser'), get_parser('InternalParser')]:
            movie = parser.parse('The.Matrix.1999.1080p.HDDVD.x264-FlexGet')
            ...
            movie = parser.parse('WALL-E 720p BluRay x264-FlexGet')
            ...
            movie = parser.parse('The.Pianist.2002.HDDVD.1080p.DTS.x264-FlexGet')
            ...
            movie = parser.parse("Howl's_Moving_Castle_(2004)_[720p,HDTV,x264,DTS]-FlexGet")
            ...
            movie = parser.parse('Coraline.3D.1080p.BluRay.x264-FlexGet')
            ...
            movie = parser.parse('Slumdog.Millionaire.DVDRip.XviD-FlexGet')
            ...
            movie = parser.parse('TRON.Legacy.3D.2010.1080p.BluRay.Half.Over-Under.DTS.x264-FlexGet')
            assert movie.name == 'TRON Legacy', 'failed to parse %s' % movie.data

            movie = parser.parse('[SomeThing]Up.2009.720p.x264-FlexGet')
            ...
            movie = parser.parse('[720p] A.Movie.Title.2013.otherstuff.x264')
