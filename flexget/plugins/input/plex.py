...
class InputPlex(object):
    ...
    'selection'         Can be set to different keys:
        ...
        - recentlyViewed
        - recentlyViewedShows
    'all' and 'recentlyViewedShows' will only produce a list of show names 
    while the other three will produce filename and download url 
    ...
    def on_task_input(self, task, config):
        ...
        try:
            r = requests.get("http://%s:%d/library/sections/%d/%s%s" % 
