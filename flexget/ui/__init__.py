...
def register_web_ui(cfg):
    ...
    if not os.path.exists(ui_dist):
        ...
        logger.critical(
            ...
            ' this can happen if you are running from GitHub version and forgot to run the '
            + 'web ui build, see http://flexget.com/wiki/Web-UI/v2 for instructions'
        )
