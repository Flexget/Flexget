...
var mockSeriesData = (function () {
        ...
        },
        {
          ...
          latest_downloaded_episode: {
            ...
            last_downloaded_release: {
              ...
              release_title:
                'The Simpsons s27e20 To Courier With Love 1080p HDTV x264 mkv-[Zeus]',
            },
    ...
    return {
      ...
      latest_downloaded_episode: {
        ...
        last_downloaded_release: {
          ...
          release_title:
            'Awkward S05E24 Happy Campers Happier Trails 1080p WEB DL AAC2 0 H264 Oosh rartv',
        },
        number_of_episodes_behind: 0,
      },
      show_id: 1,
  ...
  function getShowMetadata() {
    return {
      ...
      genres: ['Action', 'Comedy', 'Crime', 'Drama', 'Horror'],
      imdb_id: 'tt3501584',
      language: 'en',
    ...
    return {
      ...
      releases: [
        ...
        },
        {
          ...
          release_title:
            'Awkward S05E16 720p HDTV HEVC x265-RMTeam [720P][HEVC]',
        },
      ],
      show_id: 1,
    };
