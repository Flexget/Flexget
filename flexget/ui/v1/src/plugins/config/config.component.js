...
(function () {
  ...
  angular.module('plugins.config').component('configView', {
  ...
  function configController(
    ...
    function loadConfig() {
      configService.getRawConfig().then(decode).cached(decode);
    ...
    function loadVariables() {
      configService.getVariables().then(setVariables).cached(setVariables);
    ...
    function aceLoaded(_editor) {
      ...
      var commandsToRemove = ['transposeletters', 'gotoline'];
    ...
    function saveVariables() {
      ...
      configService.saveVariables(converted).then(
        function () {
          updateSuccess();
        },
        function (error) {
    ...
    function saveConfig() {
      ...
      configService.saveRawConfig(encoded).then(
        function () {
          updateSuccess();
        },
        function (error) {
    ...
    function updateSuccess() {
      var dialog = $mdDialog
        ...
        .textContent(
          'Your ' +
            (vm.variables ? 'variables have' : 'config has') +
