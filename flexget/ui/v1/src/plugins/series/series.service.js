...
(function () {
  ...
  angular.module('plugins.series').factory('seriesService', seriesService);
  ...
  function seriesService($http, exception) {
    ...
    function searchShows(searchTerm) {
      return $http
        .get('/api/series/search/' + searchTerm + '/', {
          etagCache: true,
        })
        .catch(callFailed);
    }
    ...
    function getEpisodes(show, params) {
      return $http
        .get('/api/series/' + show.id + '/episodes/', {
          params: params,
          etagCache: true,
        })
        .catch(callFailed);
    ...
    function deleteEpisode(show, episode, params) {
      return $http
        .delete('/api/series/' + show.id + '/episodes/' + episode.id + '/', {
          params: params,
        })
        .then(callComplete)
        .catch(callFailed);
    ...
    function resetReleases(show, episode) {
      return $http
        .put(
          '/api/series/' + show.id + '/episodes/' + episode.id + '/releases/',
        )
        .then(callComplete)
        .catch(callFailed);
    }
