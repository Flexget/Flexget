...
describe('Service: Series', function () {
  beforeEach(function () {
    ...
    sinon
      .stub(exception, 'catcher')
      .returns($q.reject({ message: 'Request failed' }));
  ...
  describe('getShowMetadata()', function () {
    it('should issue a GET /api/tvdb/series/:name/ request', function () {
      ...
      seriesService
        .getShowMetadata({ show_name: 'iZombie' })
        .then(function (data) {
          expect(data).to.exist;
        });
      $httpBackend.flush();
  ...
  describe('searchShows()', function () {
    it('should issue a GET /api/series/search/:term/ request', function () {
      $httpBackend
        .expect('GET', '/api/series/search/iZombie/')
        .respond(200, {});
  ...
  describe('deleteEpisode()', function () {
    it('should issue a DELETE /api/series/:sid/episodes/:eid/ request', function () {
      $httpBackend
        .expect('DELETE', '/api/series/1/episodes/1/')
        .respond(200, {});
      seriesService
        .deleteEpisode({ show_id: 1 }, { episode_id: 1 })
        .then(function (data) {
          expect(data).to.exist;
        });
      $httpBackend.flush();
  ...
  describe('resetReleases()', function () {
    it('should issue a PUT /api/series/:sid/episodes/:eid/releases/ request', function () {
      $httpBackend
        .expect('PUT', '/api/series/1/episodes/1/releases/')
        .respond(200, {});
      seriesService
        .resetReleases({ show_id: 1 }, { episode_id: 1 })
        .then(function (data) {
          expect(data).to.exist;
        });
      $httpBackend.flush();
  ...
  describe('forgetRelease()', function () {
    it('should issue a DELETE /api/series/:sid/episodes/:eid/releases/:rid/ request', function () {
      $httpBackend
        .expect('DELETE', '/api/series/1/episodes/1/releases/1/')
        .respond(200, {});
      seriesService
        .forgetRelease({ show_id: 1 }, { episode_id: 1 }, { release_id: 1 })
        .then(function (data) {
          expect(data).to.exist;
        });
      $httpBackend.flush();
  ...
  describe('resetRelease()', function () {
    it('should issue a PUT /api/series/:sid/episodes/:eid/releases/:rid/ request', function () {
      $httpBackend
        .expect('PUT', '/api/series/1/episodes/1/releases/1/')
        .respond(200, {});
      seriesService
        .resetRelease({ show_id: 1 }, { episode_id: 1 }, { release_id: 1 })
        .then(function (data) {
          expect(data).to.exist;
        });
      $httpBackend.flush();
  ...
  describe('deleteReleases()', function () {
    it('should issue a DELETE /api/series/:sid/episodes/:eid/releases/ request', function () {
      $httpBackend
        .expect('DELETE', '/api/series/1/episodes/1/releases/')
        .respond(200, {});
      seriesService
        .deleteReleases({ show_id: 1 }, { episode_id: 1 })
        .then(function () {
  ...
  describe('loadReleases()', function () {
    it('should issue a GET /api/series/:sid/episodes/:eid/releases/ request', function () {
      $httpBackend
        .expect('GET', '/api/series/1/episodes/1/releases/')
        .respond(200, {});
      seriesService
        .loadReleases({ show_id: 1 }, { episode_id: 1 })
        .then(function (data) {
          expect(data).to.exist;
        });
      $httpBackend.flush();
