...
(function () {
  ...
  angular.module('plugins.series').component('episodeRelease', {
    templateUrl:
      'plugins/series/components/episode-release/episode-release.tmpl.html',
    controllerAs: 'vm',
  ...
  function episodesReleaseController($mdDialog, $sce, seriesService) {
    ...
    function resetRelease() {
      var confirm = $mdDialog
        ...
        .htmlContent(
          $sce.trustAsHtml(
            'Are you sure you want to reset the release <b>' +
              vm.release.title +
              '</b>?',
          ),
        )
    ...
    function forgetRelease() {
      var confirm = $mdDialog
        ...
        .htmlContent(
          $sce.trustAsHtml(
            'Are you sure you want to delete the release <b>' +
              vm.release.title +
              '</b>?',
          ),
        )
