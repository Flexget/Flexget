...
(function () {
  ...
  angular.module('plugins.series').component('seriesEpisodesView', {
    templateUrl:
      'plugins/series/components/series-episodes/series-episodes.tmpl.html',
    controllerAs: 'vm',
  ...
  function episodesController($mdDialog, $sce, seriesService) {
    ...
    function deleteEpisode(episode) {
      var confirm = $mdDialog
        ...
        .htmlContent(
          $sce.trustAsHtml(
            'Are you sure you want to forget episode <b>' +
              episode.identifier +
              '</b> from show <b>' +
              vm.show.name +
              '</b>?<br /> This also removes all downloaded releases for this episode!',
          ),
        )
        .ok('Forget')
        .cancel('No');
      ...
      $mdDialog.show(confirm).then(function () {
        seriesService.deleteEpisode(vm.show, episode, params).then(function () {
