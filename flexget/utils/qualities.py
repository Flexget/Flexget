...
_color_ranges = [
    QualityComponent('color_range', 10, '8bit', r'8[^\w]?bit|hi8p'),
    QualityComponent('color_range', 20, '10bit', r'10[^\w]?bit|hi10p'),
    QualityComponent('color_range', 40, 'hdrp', r'hdr[^\w]?(\+|p|plus)'),
    QualityComponent('color_range', 30, 'hdr10', r'hdr([^\w](10))?'),
