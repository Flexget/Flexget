...
class TestSonarrListActions:
            ...
            list_match:
              from:
                - sonarr_list:
                    ...
                    api_key: %(RADARR_API_KEY)s
                    port: %(RADARR_PORT)s
    """ % {'RADARR_API_KEY': SONARR_API_KEY, 'RADARR_BASE_URL': SONARR_BASE_URL, 'RADARR_PORT': SONARRR_PORT}
    ...
    def test_sonarr_list_tags(self, execute_task, manager):
        ...
        manager.config['tasks']['clear_and_add_to_sonarr_with_tags']['list_add'][0]['sonarr_list']['tags'].append(tag_by_id)
