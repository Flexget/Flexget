...
class TestQualityParser(object):
    ...
    @pytest.mark.parametrize("test_quality", [
        ...
        ('Test.File.fullhd.web', '1080p webdl'),
        ('Test.File.fhd.web', '1080p webdl'),
        ('Test.File.2160p.web', '2160p webdl'),
        ('Test.File.ultrahd.web', '2160p webdl'),
        ('Test.File.uhd.web', '2160p webdl'),
        ('Test.File.4k.web', '2160p webdl'),
        ('Test.File.4320p.web', '4320p webdl'),
        ('Test.File.8k.web', '4320p webdl'),
