...
class TestMetainfoImdb(object):
    ...
    def test_imdb(self, execute_task):
        ...
        assert task.find_entry(imdb_url='http://www.imdb.com/title/tt0330793/', id='tt0330793'), \
            'Failed to pick url from test 1'
        assert task.find_entry(imdb_url='http://www.imdb.com/title/tt0472198/', id='tt0472198'), \
            'Failed to pick url from test 2'
        assert not task.find_entry(imdb_url='http://www.imdb.com/title/tt66666/', id='tt66666'), \
            'Failed to ignore multiple imdb urls in test 4'
        assert not task.find_entry(imdb_url='http://www.imdb.com/title/tt99999/', id='tt99999'), \
            'Failed to ignore multiple imdb urls in test 4'
